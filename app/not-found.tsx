  ...
  return (
    <>
      ...
      <main className="flex min-h-[70vh] flex-col items-center justify-center px-6 pt-16 text-center">
        <p className="mb-4 text-sm font-semibold uppercase tracking-[0.35em] text-[#78716C]">
          Error 404
        </p>
        <h1 className="mb-4 text-5xl font-black tracking-tight text-[#1C1917] sm:text-6xl">
          Espa
          <span className="text-[#BF2638]">n</span>
          <span className="text-[#6D28D9]">ias</span>
        </h1>
        <p className="mb-10 max-w-md text-lg text-[#78716C]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/catalogo"
            className="rounded-full border border-stone-300 px-7 py-3 text-sm font-semibold text-[#1C1917] transition-colors hover:border-stone-400 hover:bg-white"
          >
            Ver el catálogo
          </Link>
        </div>
