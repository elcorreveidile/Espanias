...
export const projects: Project[] = [
...

  {
    ...
    image: '/projects/academia-musica.webp',
    category: 'educacion',
    status: 'hecho',
    sector: 'música',
    description: {
      es: 'Plataforma educativa híbrida de música: clases en vivo (grupos de hasta 8 alumnos) y lecciones grabadas, con catálogo de cursos por instrumento y nivel, comunidad (foro, recitales y jam sessions) y seguimiento del alumno. 7 instrumentos y planes de suscripción.',
      en: 'Hybrid music learning platform: live classes (groups of up to 8 students) and recorded lessons, with a course catalogue by instrument and level, a community (forum, recitals and jam sessions) and student progress tracking. 7 instruments and subscription plans.',
    },
  },
